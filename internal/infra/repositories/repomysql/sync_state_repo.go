...
type SyncStateRepo struct{ *repoMySQL }

func NewSyncStateRepo(base *repoMySQL) SyncStateRepo { return SyncStateRepo{base} }
...
func (r SyncStateRepo) GetSyncState(
	...
	return SyncState{
		...
		LastSyncedAt: row.LastSyncedAt.Time.UTC(),
